<div>
    ...
    <div x-data="{ open: @entangle('showModal') }" x-show="open" x-cloak
        ...
        {{-- Modal panel --}}
        <div class="relative flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0" style="z-index: 2;">
            <div class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-xl shadow-2xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="px-6 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-6 space-y-3">
                        {{-- Excel --}}
                        <label class="flex items-center p-3 rounded-xl cursor-pointer hover:bg-gray-50 transition-all border border-gray-200">
                            ...
                            <div class="ml-3">
                                ...
                                <span class="block text-xs text-gray-500">Ekspor ke format Excel yang dapat diedit</span>
                            </div>
                            <svg class="w-8 h-8 ml-auto text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <label class="flex items-center p-3 rounded-xl cursor-pointer hover:bg-gray-50 transition-all border border-gray-200">
                            ...
                            <div class="ml-3">
                                ...
                                <span class="block text-xs text-gray-500">Ekspor ke format CSV (Comma Separated Values)</span>
                            </div>
                            <svg class="w-8 h-8 ml-auto text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <label class="flex items-center p-3 rounded-xl cursor-pointer hover:bg-gray-50 transition-all border border-gray-200">
                            ...
                            <svg class="w-8 h-8 ml-auto text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
