...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white">
            <h2 class="text-lg font-semibold text-slate-800">Form Tambah Administrator</h2>
            <p class="text-sm text-slate-500 mt-0.5">Isi data admin baru dengan lengkap</p>
        </div>

        <form action="{{ route('admin.manajemen.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="relative flex items-center p-3 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-all has-[:checked]:border-[#5b5ef4] has-[:checked]:bg-indigo-50/30">
                            <input type="radio" name="role" value="admin" class="w-4 h-4 text-[#5b5ef4] focus:ring-[#5b5ef4]" checked>
                            <div class="ml-3">
                        ...
                        <label class="relative flex items-center p-3 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-all has-[:checked]:border-[#5b5ef4] has-[:checked]:bg-indigo-50/30">
                            <input type="radio" name="role" value="super_admin" class="w-4 h-4 text-[#5b5ef4] focus:ring-[#5b5ef4]">
                            <div class="ml-3">
