...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info-label { font-size: 12px; font-weight: 600; color: #166534; margin-bottom: 8px; text-transform: uppercase; }
...
<body>
    <div class="email-container">
        <div class="email-header">
            ...
            <h1 class="email-title">Konfirmasi Perubahan Email</h1>
        </div>
        ...
        <div class="email-body">
            ...
            <div class="info-box">
                <div class="info-label">Email Baru</div>
                <div class="info-value">{{ $newEmail }}</div>
            </div>

            <div class="warning-box">
                <strong>Perhatian:</strong> Jika Anda tidak merasa melakukan permintaan ini, abaikan email ini. Email Anda tidak akan berubah.
            </div>

            <div style="text-align: center;">
                <a href="{{ route('admin.profile.confirm-email-change', ['token' => $token]) }}" class="button">
            ...
            <div class="closing">
                <div class="closing-text">
                    ...
                    <small style="color: #5b5ef4; word-break: break-all;">
                        {{ route('admin.profile.confirm-email-change', ['token' => $token]) }}
                    </small>
                </div>
                <div class="signature">
